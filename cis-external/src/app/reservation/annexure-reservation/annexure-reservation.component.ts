...
@Component({
    selector: 'app-annexure-reservation',
    templateUrl: './annexure-reservation.component.html',
    styleUrls: ['./annexure-reservation.component.css']
})
export class AnnexureReservationComponent implements OnInit, OnChanges {
    @Input() draftId;
    @Input() readonly;
    @Input() supportingDoc;
    @Input() draftData: any;
