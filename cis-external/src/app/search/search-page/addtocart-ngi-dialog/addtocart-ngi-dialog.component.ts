...
@Component({
  selector: 'app-addtocart-ngi-dialog',
  templateUrl: './addtocart-ngi-dialog.component.html',
  styleUrls: ['./addtocart-ngi-dialog.component.css']
})
export class AddtocartNgiDialogComponent implements OnInit {
  ...
  constructor(private snackbar: SnackbarService, private fb: FormBuilder, private dialog: MatDialog, private router: Router,
    ...
    private changeDetectorRefs: ChangeDetectorRef, public dialogRef: MatDialogRef<AddtocartNgiDialogComponent>,
  ...
  loadData() {
    ...
    ]).subscribe(([formatType, coordinateType, reqType]) => {
  ...
  addToCart() {
    ...
    for (let i = 0; i < this.data.results.length; i++) {
      ...
      const data = {
        ...
        searchDetails: this.data.searchDetails[i],
