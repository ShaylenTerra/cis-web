...
@Component({
  selector: 'app-lodgement-decision',
  templateUrl: './lodgement-decision.component.html',
  styleUrls: ['./lodgement-decision.component.css']
})
export class LodgementDecisionComponent implements OnInit, OnChanges {
  @Input() draftData;
  @Input() readonly;
  @Input() taskDetail;
  @Input() workflowId;
