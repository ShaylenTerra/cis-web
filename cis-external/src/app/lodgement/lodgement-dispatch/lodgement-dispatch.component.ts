...
@Component({
  selector: 'app-lodgement-dispatch',
  templateUrl: './lodgement-dispatch.component.html',
  styleUrls: ['./lodgement-dispatch.component.scss']
})
export class LodgementDispatchComponent implements OnInit, OnChanges {
  dispatchMethodName;
  dispatchMedia;
  selectedModes;
  deliveryMediasdata;
