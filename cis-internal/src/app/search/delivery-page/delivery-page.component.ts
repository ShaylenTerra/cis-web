...
export class DeliveryPageComponent implements OnInit {
    ...
    constructor(public dialog: MatDialog, private fb: FormBuilder, private searchService: SearchService,
        ...
        this.deliveryForm = this.fb.group({
            ...
            notes: '', // TODO:bind data from input form
    ...
    checkout() {
        ...
        if (this.selectedMode.caption === 'COURIER' && this.form.invalid) {
            ...
            // const reqData = JSON.parse(this.cartData.cartStageData[0].jsonData).requesterDetails;

            const payload = {
                // addressData: addressData != null ? JSON.stringify(addressData) : '',
                requesterInformation: JSON.stringify(this.requestorData), // JSON.stringify(reqData),
