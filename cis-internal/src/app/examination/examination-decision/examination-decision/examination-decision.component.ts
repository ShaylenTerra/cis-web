...
@Component({
  selector: 'app-examination-decision',
  templateUrl: './examination-decision.component.html',
  styleUrls: ['./examination-decision.component.css']
})
export class ExaminationDecisionComponent implements OnInit {
