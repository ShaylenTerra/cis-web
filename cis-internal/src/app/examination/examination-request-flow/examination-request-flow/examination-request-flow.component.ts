...
@Component({
  selector: 'app-examination-request-flow',
  templateUrl: './examination-request-flow.component.html',
  styleUrls: ['./examination-request-flow.component.css']
})
export class ExaminationRequestFlowComponent implements OnInit {
  result: any[] = [];
  @Input() workflowId;
