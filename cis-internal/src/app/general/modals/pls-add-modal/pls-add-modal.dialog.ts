...
@Component({
    selector: 'app-pls-add-modal',
    templateUrl: './pls-add-modal.dialog.html',
    styleUrls: ['./pls-add-modal.dialog.css']
})
export class PLSAddModalDialogComponent implements OnInit {
    ...
    prefixCode: any = 'GPR LS ';
    org: any;
    emailPattern = '^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$';
    constructor(public dialogRef: MatDialogRef<PLSAddModalDialogComponent>, private fb: FormBuilder,
